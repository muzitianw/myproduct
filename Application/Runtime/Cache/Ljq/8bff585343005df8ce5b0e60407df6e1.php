...
<div id="theme-wrapper">
    <header class="navbar" id="header-navbar">
        <div class="container">
            <a href="<?php echo U('Index/index');?>" id="logo" class="navbar-brand">
                <img src="/Public/Ljq/cube/img/logo.png" alt="" class="normal-logo logo-white"/>
                <img src="/Public/Ljq/cube/img/logo-black.png" alt="" class="normal-logo logo-black"/>
                <img src="/Public/Ljq/cube/img/logo-small.png" alt="" class="small-logo hidden-xs hidden-sm hidden"/>
            </a>
            ...
            <div class="clearfix">
                ...
                <div class="nav-no-collapse pull-right" id="header-nav">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li>
                            <a href="<?php echo U('User/logins');?>">
                                <span class="hidden-xs">Sign up</span> <!--<b class="caret"></b>-->
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo U('User/registers');?>">
                                <span class="hidden-xs">Sign in</span> <!--<b class="caret"></b>-->
                            </a>
                        </li>
                        <!--
                        <li class="dropdown profile-dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="/Public/Ljq/cube/img/samples/scarlet-159.png" alt=""/>
...
<script src="/Public/Ljq/cube/js/pace.min.js"></script>
